...
public:
  ...
  Embedding(WordList*);
  void load_input(std::vector<std::string>&);  //read the input data and output the matrix, and the input,output,positional will be initialize by the size of input vector<string>
